...
<div id="menuList" class="list-group">
  ...
  <div class="row g-2 pb-2 mt-1" id="row<?php echo $link[ 'id' ]; ?>" data-id="<?php echo $link[ 'id' ]; ?>" style="background-color: #F1F1F1;">
      ...
      <div class="col-lg-1 text-center"><?php echo '<img src="' . $location . $link
      [ 'image' ] . '" alt=""  class="img-fluid">';?></div>
    
      <div class="col-lg-4"> <?php echo input("text", 'subject', $link['subject'], "subject".$link['id'], 'class="form-control autosave" data-field="subject" data-set="'.$link['hash'].'"'); ?> </div>
    ...
    <div class="col-lg-1 text-center">
        ...
        <a href="/admin/carousel/edit/<?php echo $link['id']; ?>/" class="btn btn-dark btn-sm edit-btn mt-1"><i class="bi bi-pencil"></i></a>
