...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<div><strong>of sleep hier een afbeelding naar toe...</strong></div>",
            abortStr: "Stop",
            cancelStr: "Annuleren",
            deletelStr: "Verwijder",
            doneStr: "Klaar",
            multiDragErrorStr: "Meerdere afbeeldingen slepen is niet toegestaan.",
            extErrorStr: "is niet toegestaan. Toegestane extensies zijn: ",
            sizeErrorStr: "is niet toegestaan. Toegestane : ",
            uploadErrorStr: "Upload is niet toegestaan"
        }, options);
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    var dragDrop = $('<div class="well" style="vertical-align:top;"></div>');
                    $(obj).before(dragDrop);
        ...
        this.stopUpload = function () {
            $(".btn-warning").each(function (i, items) {
        ...
        function createProgressDiv(obj, s) {
            this.statusbar = $("<div class='well'></div>");
            this.filename = $("<p></p>").appendTo(this.statusbar);
            this.progressDiv = $("<div class='progress'>").appendTo(this.statusbar).hide();
            this.progressbar = $("<div class='progress-bar progress-bar-primary " + obj.formGroup + "'></div>").appendTo(this.progressDiv);
            this.abort = $("<div class='btn btn-danger " + obj.formGroup + "'>" + s.abortStr + "</div>").appendTo(this.statusbar).hide();
            this.cancel = $("<div class='btn btn-danger'>" + s.cancelStr + "</div>").appendTo(this.statusbar).hide();
            this.done = $("<div class='btn btn-success'>" + s.doneStr + "</div>").appendTo(this.statusbar).hide();
            this.del = $("<div class='btn btn-danger'>" + s.deletelStr + "</div>").appendTo(this.statusbar).hide();
