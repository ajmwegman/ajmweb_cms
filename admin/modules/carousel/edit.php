...
if (!$row) {
    echo '<div class="alert alert-danger">Carousel item niet gevonden voor ID: ' . htmlspecialchars($id) . '</div>';
    echo '<a href="/admin/carousel/" class="btn btn-secondary">Terug naar overzicht</a>';
    exit;
}
