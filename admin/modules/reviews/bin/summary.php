...
require_once( $path . "/admin/modules/reviews/src/review.class.php" );
...
<div id="menuList" class="list-group">
  ...
  <div class="row g-2 pb-2 mt-1" id="row<?php echo $link[ 'id' ]; ?>" data-id="<?php echo $link[ 'id' ]; ?>" style="background-color: #F1F1F1;">
    ...
    <div class="col-lg-2"> <?php echo input("date", 'reviewdate[]', $link['reviewdate'], "reviewdate".$link['id'], 'class="form-control autosave" data-field="reviewdate" data-set="'.$link['hash'].'"'); ?> </div>
    <div class="col-lg-5"> <?php echo input("text", 'subject', $link['subject'], "subject".$link['id'], 'class="form-control autosave" data-field="subject" data-set="'.$link['hash'].'"'); ?> </div>
    <div class="col-lg-2"> <?php echo input("text", 'location[]', $link['location'], "location".$link['id'], 'class="form-control autosave" data-field="location" data-set="'.$link['hash'].'"'); ?> </div>
    <div class="col-lg-1"> <?php echo input("text", 'score[]', $link['score'], "score".$link['id'], 'class="form-control autosave" data-field="score" data-set="'.$link['hash'].'"'); ?> </div>
    <div class="col-lg-1 text-center">
        ...
        <a href="/admin/reviews/edit/<?php echo $link['id']; ?>/" class="btn btn-dark btn-sm edit-btn mt-1"><i class="bi bi-pencil"></i></a>
