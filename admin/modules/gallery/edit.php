<?php
require_once("src/gallery.class.php"); 
...
<div class="row mt-4" id="add_space">
	...
	<div class="col-md-12">
		<div class="float-end"><a href="/admin/gallery/" class="btn btn-dark">Terug</a></div>
...
<script src="/admin/modules/gallery/js/imageupload.js"  type="text/javascript"></script>
