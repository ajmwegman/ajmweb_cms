<form action="/admin/modules/newsletter_memberlist/bin/add.php" enctype="multipart/form-data" method="post" name="menuform" id="menuform" autocomplete="off">
  <input type="hidden" id="hash" name="hash" value="">
  <div class="row mt-4">
    <div class="col-md-12">
      <div class="card shadow">
        <div class="card-header">
          <h5>Nieuwsbrief gebruiker toevoegen</h5>
        </div>
        <div class="card-body">
          <div class="row">
          <div class="row mt-2">
