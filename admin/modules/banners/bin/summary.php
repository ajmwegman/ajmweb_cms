...
<div id="menuList" class="list-group">
  ...
  <div class="row g-2 pb-2 mt-1" id="row<?php echo $link[ 'id' ]; ?>" data-id="<?php echo $link[ 'id' ]; ?>" style="background-color: #F1F1F1;">
    ...
    <div class="col-lg-2"> <?php echo input("date", 'startdate', $link['startdate'], "startdate".$link['id'], 'class="form-control autosave" data-field="startdate" data-set="'.$link['hash'].'"'); ?> </div>
   
      <div class="col-lg-2"> <?php echo input("date", 'enddate', $link['enddate'], "enddate".$link['id'], 'class="form-control autosave" data-field="enddate" data-set="'.$link['hash'].'"'); ?> </div>
      
     
    <div class="col-lg-2"> <?php echo input("text", 'advertiser', $link['advertiser'], "advertiser".$link['id'], 'class="form-control autosave" data-field="advertiser" data-set="'.$link['hash'].'"'); ?> </div>
      
    <div class="col-lg-1 text-center"><a href="<?php echo $link['url']; ?>" class="text-link" target="_blank"><i class="bi bi-globe2"></i></a></div>
    ...
    <div class="col-lg-1 text-center">
        ...
        <a href="/admin/banners/edit/<?php echo $link['id']; ?>/" class="btn btn-dark btn-sm edit-btn mt-1"><i class="bi bi-pencil"></i></a>
