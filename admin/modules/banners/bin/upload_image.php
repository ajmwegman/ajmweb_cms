...
if(isset($_FILES["myfile"]))
{
	...
	if(!is_array($_FILES["myfile"]["name"])) //single file
	{
		...
		$extension = $banner->check_extension($fileName, $allowed);
		
		// max banner
		$banner = $banner->image_resize($extension, $max_banner_size, $location, $output_dir, $fileName, 90);
