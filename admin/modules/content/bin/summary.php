...
<div id="menuList" class="list-group">
  ...
  foreach ( $list as $row => $data ) {
    ...
    ?>
  <div class="row p-1 mt-1 bg-light" id="row<?php echo $data[ 'id' ]; ?>" data-id="<?php echo $data[ 'id' ]; ?>">
    <div class="col-md-9 p-2"> <?php echo $data['title']; ?> </div>
    <div class="col-md-3 p-2 text-end"> 
        ...
        <div class="col">
             <div class="bi bi-grip-vertical drag-handler"></div>
            </div>
        </div>
