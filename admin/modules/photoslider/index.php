...
if ( $module == 'photoslider' && $action == 'edit' ) {
?>
<?php require_once("edit.php"); ?>
<?php } else { 

// Instantieer de class en haal de sliders op
require_once("src/photoslider.class.php");

$photoslider = new photoslider($pdo); // Zorg ervoor dat $pdo correct is geïnitialiseerd
$sliders = $photoslider->getAllSliders();
...
<?php } ?>
<script src="/admin/modules/photoslider/js/menulist.js"  type="text/javascript"></script>
